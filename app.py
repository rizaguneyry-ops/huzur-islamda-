...
# Hata veren 'liste' anahtarı tüm dillere eksiksiz eklendi
languages = {
    ...
    "العربية": {"vakit": "الوقت المتبقي", "zikir": "المسبحة", "esma": "أسماء الله", "kuran": "آخر 10 سور", "artir": "تسبيح", "sifirla": "إعادة", "farz": "32 فرض", "abdest": "الوضوء", "liste": "القائمة"},
    "Deutsch": {"vakit": "RESTZEIT", "zikir": "ZÄHLER", "esma": "99 NAMEN", "kuran": "10 SUREN", "artir": "ZÄHLEN", "sifirla": "RESET", "farz": "32 PFLICHTEN", "abdest": "WUDU", "liste": "LISTE"},
    "Español": {"vakit": "TIEMPO", "zikir": "CONTADOR", "esma": "99 NOMBRES", "kuran": "10 SURAS", "artir": "CONTAR", "sifirla": "RESETEAR", "farz": "32 OBLIGACIONES", "abdest": "WUDU", "liste": "VER LISTA"},
    "Italiano": {"vakit": "TEMPO", "zikir": "TASBIH", "esma": "99 NOMI", "kuran": "10 SURE", "artir": "CONTA", "sifirla": "RESET", "farz": "32 OBBLIGHI", "abdest": "WUDU", "liste": "LISTA"},
    "中文": {"vakit": "剩余时间", "zikir": "念珠", "esma": "真主尊名", "kuran": "最后10章", "artir": "计数", "sifirla": "重置", "farz": "32 义务", "abdest": "小净", "liste": "列表"}
}
...
st.markdown(f"""
    ...
    .module-card {{
        ...
        border: 1px solid #d4af37; color: white; min-height: 380px; text-align: center;
        margin-bottom: 20px;
    }}
    </style>
...
with c1:
    ...
    with st.expander(f"{L['liste']}"):
        st.write("1. Allah, 2. Er-Rahman, 3. Er-Rahim, 4. El-Melik, 5. El-Kuddüs, 6. Es-Selam, 7. El-Mü'min, 8. El-Müheymin, 9. El-Aziz...")
...
with col_farz:
    with st.expander(f"✨ {L['farz']}"):
        st.write("İmanın Şartları, İslamın Şartları, Namazın Farzları...")
with col_abdest:
    with st.expander(f"💧 {L['abdest']}"):
        st.write("Abdestin alınışı ve farzları...")